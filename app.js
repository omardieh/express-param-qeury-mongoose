...
// http://localhost:3000/search?title=iPhone 9
// app.get("/search", (req, res) => {
//   if (req.query.title) {
//     res.json(products.filter((product) => product.title === req.query.title));
//     return;
//   }
//   res.json(products);
// });
...
// www.domain.com (React)
// React
// "/users/:username"
// useEffect(() => {fetch("api.domain.com/users/:username")}, [])

// frontend App :
// useEffect(() => {
//   const result = fetch("api.domain.com//profile"})
// setUser(result)
// "/profile"
...
// const result = db.find({username: req.params.username})
// resp.json({user : result})
// })
